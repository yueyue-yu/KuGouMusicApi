...
- [KuGouMusic API](#kugoumusic-api)
  ...
  - [接口文档](#接口文档)
    ...
    - [登录](#登录)
      - [1.手机登录](#1手机登录)
      - [2. 用户名登录(该登录可能需要验证，不推荐使用)](#2-用户名登录该登录可能需要验证不推荐使用)
      - [3. 开放接口登录(目前仅支持微信登录)](#3-开放接口登录目前仅支持微信登录)
      - [4. 二维码登录](#4-二维码登录)
        - [1.二维码 key 生成接口](#1二维码-key-生成接口)
        - [2.二维码生成接口](#2二维码生成接口)
        - [2.二维码检测扫码状态接口](#2二维码检测扫码状态接口)
      - [5. 微信登录](#5-微信登录)
        - [1. 二维码生成接口](#1-二维码生成接口)
        - [2.二维码检测扫码状态接口](#2二维码检测扫码状态接口-1)
    - [刷新登录](#刷新登录)
    - [发送验证码](#发送验证码)
    - [dfid 获取](#dfid-获取)
    - [获取用户额外信息](#获取用户额外信息)
    ...
    - [获取用户关注歌手](#获取用户关注歌手)
    - [获取用户云盘](#获取用户云盘)
    - [获取用户云盘音乐 URL](#获取用户云盘音乐-url)
    - [获取用户收藏的视频](#获取用户收藏的视频)
    - [获取用户喜欢的视频](#获取用户喜欢的视频)
    - [获取用户听歌历史排行](#获取用户听歌历史排行)
    - [获取用户最近听歌历史](#获取用户最近听歌历史)
    - [获取继续播放信息（对应手机版首页显示继续播放入口）](#获取继续播放信息对应手机版首页显示继续播放入口)
    - [收藏歌单/新建歌单](#收藏歌单新建歌单)
    - [取消收藏歌单/删除歌单](#取消收藏歌单删除歌单)
    - [对歌单添加歌曲](#对歌单添加歌曲)
    - [对歌单删除歌曲](#对歌单删除歌曲)
    - [新碟上架](#新碟上架)
    - [专辑信息](#专辑信息)
    ...
    - [获取更多音乐版本](#获取更多音乐版本)
    - [获取音乐伴奏信息](#获取音乐伴奏信息)
    - [获取音乐 K 歌数量](#获取音乐-k-歌数量)
    - [获取音乐详情](#获取音乐详情)
    - [获取音乐专辑/歌手信息](#获取音乐专辑歌手信息)
    - [私人 FM(对应手机和 pc 端的猜你喜欢)](#私人-fm对应手机和-pc-端的猜你喜欢)
    - [banner](#banner)
    - [乐库 banner](#乐库-banner)
    - [乐库电台](#乐库电台)
    - [乐库](#乐库)
    ...
    - [编辑精选专区](#编辑精选专区)
    - [编辑精选专区详情](#编辑精选专区详情)
    - [领取 VIP（需要登陆，该接口为测试接口,仅限概念版使用）](#领取-vip需要登陆该接口为测试接口仅限概念版使用)
    - [领取一天 VIP（需要登陆，该接口为测试接口,仅限概念版使用）](#领取一天-vip需要登陆该接口为测试接口仅限概念版使用)
    - [获取当月已领取 VIP 天数（需要登陆，该接口为测试接口,仅限概念版使用）](#获取当月已领取-vip-天数需要登陆该接口为测试接口仅限概念版使用)
    - [获取已领取 VIP 状态（需要登陆，该接口为测试接口,仅限概念版使用）](#获取已领取-vip-状态需要登陆该接口为测试接口仅限概念版使用)
    - [获取歌手列表](#获取歌手列表)
    - [获取歌手详情](#获取歌手详情)
    - [获取歌手专辑](#获取歌手专辑)
    - [获取歌手单曲](#获取歌手单曲)
    ...
    - [场景音乐详情](#场景音乐详情)
    - [获取场景音乐讨论区](#获取场景音乐讨论区)
    - [获取场景音乐模块 Tag](#获取场景音乐模块-tag)
    - [获取场景音乐歌单列表](#获取场景音乐歌单列表)
    - [获取场景音乐视频列表](#获取场景音乐视频列表)
    - [获取场景音乐音乐列表](#获取场景音乐音乐列表)
    - [每日推荐](#每日推荐)
    - [历史推荐](#历史推荐)
    - [风格推荐](#风格推荐)
    - [排行列表](#排行列表)
    ...
    - [歌曲评论数](#歌曲评论数)
    - [歌曲评论](#歌曲评论)
    - [歌曲评论-根据分类返回](#歌曲评论-根据分类返回)
    - [歌曲评论-根据热词返回](#歌曲评论-根据热词返回)
    - [楼层评论](#楼层评论)
    - [歌单评论](#歌单评论)
    - [专辑评论](#专辑评论)
    - [歌曲曲谱](#歌曲曲谱)
    ...
    - [听书 - 专辑详情](#听书---专辑详情)
    - [听书 - 专辑音乐列表](#听书---专辑音乐列表)
    - [歌曲详情 - 歌曲成绩单](#歌曲详情---歌曲成绩单)
    - [歌曲详情 - 歌曲成绩单详情](#歌曲详情---歌曲成绩单详情)
  - [License](#license)
